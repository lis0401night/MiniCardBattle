...
elf: {
    id: 'elf', stageId: 'android', name: '流浪の射手 リナ',
        desc: '記憶を失い、銀の弓と共に旅を続けるエルフの少女。その静かな佇まいには、隠しきれない高潔さが漂う。',
            filter: 'none', cardType: 'set1', cardBg: 'bg1',
                image: 'assets/char_lina.png', imageLose: 'assets/char_lina_lose.png', icon: 'assets/icon_lina.png', imageEnding: 'assets/char_lina_ending.png', color: '#4ade80',
                    leaderSkill: { name: '星墜ちの矢', desc: '(SP:3) 相手の場のカード1枚を選択して破壊する。', cost: 3, action: 'targeted_destruction' },
    preBattleLine: '私はを探しているの……。邪魔をしないで。',
    ...
    dialogue: {
        intro: { default: '……私の邪魔をしないで。矢を放つ準備はできているわ。' },
        win: { default: 'これが……私の力？ 少しだけ、何かを思い出した気がする。' },
        lose: { default: '視界が霞む……。私はまた、何も知らずに消えていくの……？' },
