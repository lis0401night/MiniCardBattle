...
const CARD_MASTER = [
    ...
    { id: 'cleric', name: '回復', power: 3, skill: 'heal', desc: 'リーダーのHPを3回復。' },
    { id: 'sniper', name: '狙撃', power: 2, skill: 'snipe', desc: '敵最大パワーに4ダメージ。' },
    { id: 'bomber', name: '拡散', power: 2, skill: 'spread', desc: '敵全体に2ダメージ。' },
    { id: 'mimic', name: '複製', power: 1, skill: 'copy', desc: '味方最大パワーと同じになる。' },
    { id: 'commander', name: '援護', power: 3, skill: 'support', desc: '他の味方全員のパワー+2。' },
    { id: 'golem', name: '防御', power: 10, skill: 'defender', desc: '攻撃できないが壁になる。' },
    { id: 'wolf', name: '単騎', power: 3, skill: 'lone_wolf', desc: '空きレーン数×3パワーアップ。' },
    { id: 'lich', name: '魂縛', power: 4, skill: 'soul_bind', desc: '敵破壊時にパワー+2。' },
