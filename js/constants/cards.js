...
const CARD_MASTER = [
    ...
    { id: 'diviner', name: '星詠みの占術士', power: 4, skill: 'draw', skillValue: 2, rarity: 1, voiceCategory: 'holy', flavor: '天球の運行を読み解き、運命の糸を紡ぎ直す導き手。' },
    ...
    { id: 'redhood', name: 'レッドフード', power: 3, rarity: 3, skills: [{ id: 'legendary' }, { id: 'choice' }], choices: [{ id: 'snipe', value: 5 }, { id: 'spread', value: 1 }], flavor: '赤い頭巾に隠された鋭い眼光。彼女のクロスボウから放たれる矢は、森の静寂を破ることなく標的の心臓を射抜く。' },
