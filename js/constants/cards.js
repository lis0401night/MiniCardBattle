...
const CARD_MASTER = [
    ...
    { id: 'dinosaur', name: '古代の大蜥蜴', power: 8, skill: 'takeover', rarity: 1, voiceCategory: 'monster_large', flavor: '古代の息吹を宿す巨大な爬虫類。その巨体を現すには、相応の代償が必要となる。', imgUrl: 'assets/card_dinosaur.jpg' },
    ...
    { id: 'bahamut', name: '終焉の双頭龍', power: 9, rarity: 3, skills: [{ id: 'legendary' }, { id: 'sacrifice', value: 2 }, { id: 'berserk', value: 2 }, { id: 'double_strike' }], flavor: '二つの首が天を仰ぎ、終末の咆哮を上げる。その翼が振り下ろされる時、世界は劫火に包まれる。', imgUrl: 'assets/card_bahamut.jpg' },
