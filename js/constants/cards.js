...
const CARD_MASTER = [
    ...
    { id: 'cleric', name: '見習い修道女', power: 3, skill: 'heal', skillValue: 2, rarity: 1, voiceCategory: 'human_female', flavor: '救済を志し修業に励む乙女。未熟ながらもその祈りは傷ついた心を癒やす。' },
    ...
    { id: 'empress', name: '蒼穹の審判者', power: 3, skills: [{ id: 'legendary' }, { id: 'heal', value: 3 }, { id: 'snipe', value: 3 }], rarity: 3, voiceCategory: 'holy', flavor: '宇宙の理を掌るオーブを掲げ、全ての魂に等しく審判を下す聖女。' },
