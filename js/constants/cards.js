...
const CARD_MASTER = [
    ...
    { id: 'vampire', name: '渇きの王', power: 6, skills: [{ id: 'sacrifice', value: 2 }, { id: 'soul_bind', value: 4 }, { id: 'growth', value: -2 }], rarity: 3, flavor: '冷笑を浮かべる夜の支配者. 彼の者に狙われた者は、魂の底まで吸い尽くされる。', imgUrl: 'assets/card_vampire.jpg' },
    ...
    { id: 'redhood', name: 'レッドフード', power: 3, rarity: 4, skills: [{ id: 'legendary' }, { id: 'choice' }], choices: [{ id: 'snipe', value: 5 }, { id: 'spread', value: 1 }], flavor: '赤い頭巾に隠された鋭い眼光。彼女のクロスボウから放たれる矢は、森の静寂を破ることなく標的の心臓を射抜く。' },
