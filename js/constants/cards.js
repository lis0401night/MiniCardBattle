...
const CARD_MASTER = [
    ...
    { id: 'bard', name: '森の歌うたい', power: 2, skills: [{ id: 'support', value: 2 }, { id: 'heal', value: 2 }], rarity: 2, flavor: 'ウクレレを奏でる彼を、森の動物たちは親しみを持って「先生」と呼ぶ。その歌声は傷ついた心も体も癒やす。', imgUrl: 'assets/card_bard.jpg' },
    ...
    { id: 'dealer', name: 'デビル・ディーラー', power: 3, skills: [{ id: 'draw', value: 4 }, { id: 'sacrifice', value: 2 }], rarity: 2, flavor: '「さあ、運命を選びな。代償は君の魂で十分だ。」不敵な笑みを浮かべる悪魔の占い師。', imgUrl: 'assets/card_dealer.jpg' },
