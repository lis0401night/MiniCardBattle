...
const CARD_MASTER = [
    ...
    { id: 'charger', name: 'チャージャー', power: 1, skill: 'charge', skillValue: 1, rarity: 1, flavor: '小さいバッテリー供給ロボット。味方のエネルギーを補給し、戦線の維持を助ける。' },
    { id: 'crenellatedwall', name: '銃眼付きの門', power: 5, skills: [{ id: 'spread', value: 1 }, { id: 'defender' }], rarity: 1, flavor: '銃眼付きの堅牢な木製の門。中に居る弓兵が弓矢を構え、近づく敵を迎え撃つ。' },
