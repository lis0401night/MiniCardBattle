 ...
 */
const CARD_MASTER = [
    { id: 'golem', name: '旧型タイタン', power: 5, skill: 'none', flavor: '古代文明の造兵兵器。旧式ながらもその重厚な装甲は今なお健在である。' },
    { id: 'scorpion', name: 'ブラック・スコーピオン', power: 2, skill: 'deadly', flavor: '夜の砂漠に潜む漆黒の巨蠍。その尾から放たれる猛毒は対象を一瞬で絶命させる。' },
    { id: 'diviner', name: '星詠みの占術士', power: 4, skill: 'draw', flavor: '天球の運行を読み解き、運命の糸を紡ぎ直す導き手。' },
    ...
    { id: 'wolf', name: '真夜中の狩人', power: 2, skill: 'lone_wolf', skillValue: 3, flavor: '月の光を浴びて強靭な力を得る孤高の戦士。群れを嫌い、独りで獲物を追い詰める。' },
    ...
    { id: 'berserker', name: '狂戦士', power: 7, skill: 'berserk', skillValue: 2, flavor: '破壊の衝動に魂を売った禁忌の戦士。痛みすら悦びとして斧を振り回す。' },
