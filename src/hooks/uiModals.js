...
export function setShowConfirmModalHook(h) { showConfirmModalHook = h; }
export function showConfirmModal(message, onConfirm, onCancel = null, isAlert = false) {
    if (showConfirmModalHook) return showConfirmModalHook(message, onConfirm, onCancel, isAlert);
    console.warn("GlobalModals not mounted: showConfirmModal fallback missing");
}

export let showAlertModalHook = null;
export function setShowAlertModalHook(h) { showAlertModalHook = h; }
...
export function setShowErrorModalHook(h) { showErrorModalHook = h; }
