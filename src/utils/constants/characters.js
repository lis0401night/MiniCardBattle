  ...
  dragon: {
    ...
    dialogue: {
      intro: {
        ...
        automata: 'なによ、その難しい顔。何か悪いものでも食べたの？ アイギスとは大違いね！',
  ...
  knight: {
    ...
    dialogue: {
      ...
      win: {
        ...
        automata: '人々を恐怖に陥れるのではなく、導くのだ。私がそれを証明してみせる。お前たちも、共に歩もう！',
  ...
  elf: {
    ...
    dialogue: {
      intro: {
        ...
        automata: 'あなたからは……とても悲しい気持ちを感じる。アイギスと同じ人形なのに……全然違うのね。',
  ...
  cleric: {
    ...
    dialogue: {
      ...
      win: {
        ...
        automata: 'アハハハ！ 人形は人形らしく、スクラップになりなさい！',
  ...
  witch: {
    ...
    dialogue: {
      intro: {
        ...
        automata: 'あの人とはまた違ったベクトルで面倒くさそうな人形ですね……。はぁ。',
        default:
