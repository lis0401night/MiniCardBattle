...
export const CHARACTERS = {
    android: {
        ...
        dialogue: {
            intro: { dragon: '対象の熱源反応を確認。警戒してください。', knight: '対象の装甲、旧式と推測。物理演算を開始します。', cthulhu: '非論理的生命体を検出。排除プログラムを実行します。', elf: '未知の生体反応を確認。過去データの照合に失敗。追跡を開始。', cleric: '高エネルギーの魔力反応を検出。精神汚染の危険性あり。警戒を最大に。', satan: '分類不能な超高エネルギー体を確認。リミッターを解除します。', devilhunter: '武装した不審者を検知。危険度【高】と判定し、迎撃します。', witch: '時空間の異常な歪みを検知。対象は危険な特異点です。排除します。', oni: '対象から未知の霊的エネルギーと、鬼の生態反応を同時検知。分析不能、即時排除します。', default: 'マスター、バトルプロトコルを開始します。' },
            win: { dragon: '熱源の鎮火を確認。', knight: '旧式装甲の突破完了。', cthulhu: '非論理的エラーを排除。', elf: '対象の沈黙。記憶データの断片を回収。', cleric: '異端エネルギーの霧散を確認。', satan: '対象の完全消滅を確認。私の、勝ちです。', devilhunter: '武装解除。不法投棄された棺桶は回収します。', witch: '特異点の修復完了。時空間は正常化されました。', oni: '霊的エネルギーの減衰を確認。対象の封印術式は無効化されました。', default: '対象の沈黙を確認。ミッションコンプリート。' },
    ...
    dragon: {
        ...
        dialogue: {
            intro: { android: 'なんだか鉄臭いヤツ！ 溶かしてやる！', knight: 'また騎士？ 私の巣を荒らしたヤツの仲間ね！', cthulhu: 'うわ、気持ち悪いタコ！ 焼きダコにしてやる！', elf: 'ひょろひょろのエルフ！ 私の火遊びに耐えられるかしら？', cleric: 'うさんくさい女ね！ その服もまとめて燃やしてやるわ！', satan: '魔王だかなんだか知らないけど、私の炎のほうが強いんだから！', devilhunter: 'なによその変な箱！ 私の炎でそっちも燃やし尽くしてやるんだから！', witch: 'なによその偉そうな態度！ 私の炎で黒焦げにしてやるんだから！', oni: '鬼の陰陽師？ 面白そうじゃない！ 私の炎とあんたの術、どっちが熱いか勝負よ！', default: 'ガウッ！ 私の炎で丸焦げにしてやるんだから！' },
            win: { android: 'ただのガラクタになっちゃったわね！', knight: 'ふんっ、ノロマね！', cthulhu: 'うげぇ、美味しそうじゃない……。', elf: '森へ帰って、冷えた果物でも食べてなさい！', cleric: 'ほらほら、神様にお祈りしなくていいの？', satan: 'へへーん！ ドラゴンが一番強いに決まってるでしょ！', devilhunter: 'あははっ！ 棺桶ごと黒焦げね！', witch: '時間を止めようが、私の炎は消せないのよ！', oni: 'へへーん！ 札切れね！ 私の炎の勝ちよ！', default: 'ふんっ、他愛ないわね！' },
    ...
    knight: {
        ...
        dialogue: {
            intro: { android: '魔導人形か……油断はしない！', dragon: '竜の落とし子よ, 容赦はしないぞ！', cthulhu: '邪神の眷属め！ 聖剣で浄化してくれる！', elf: '森の番人か……。すまないが、道を開けてもらおう。', cleric: '貴女……本当に聖職者なのか？ そして纏う空気に邪気を感じるぞ。', satan: '魔王……！ ここで貴様を討ち、世界に平和を！', devilhunter: '死者の魂を閉じ込めるなど邪道！ 聖なる剣で裁きを下す！', witch: '時を操る魔女か……。しかし、私の歩みは止められないぞ！', oni: '鬼の力と陰陽の術、二つの力を併せ持つか。だが、私の聖剣は揺るがない！', default: '我が剣に誓って、正々堂々と勝負しよう！' },
            win: { android: '見事な剣筋だった。', dragon: '少しは懲りたか。', cthulhu: '光の前に邪悪は滅びるのだ！', elf: '風のような身のこなし……。危ういところだった。', cleric: '偽りの信仰など、私の剣には通用しない！', satan: 'ついに、悲願達成された！ 我が剣の勝利だ！', devilhunter: '哀れな魂たちよ、安らかに眠りたまえ。', witch: '時間が止まろうとも、私の信念は砕けはしない！', oni: '見事な封印術だった。だが、私の歩みは止められない！', default: '素晴らしい勝負だった。君の戦術も見事だ。' },
    ...
    cthulhu: {
        ...
        dialogue: {
            intro: { android: '感情のないお人形……つまらないわね。', dragon: '爬虫類は嫌いですの。', knight: '無駄な信念ですねぇ……。', elf: 'あら、迷い子のエルフさん。その記憶ごと、私が飲み込んであげましょうか？', cleric: 'フフ、同業者かしら？ でも貴女の神様、私の神様よりずっと意地悪そう。', satan: 'あら、魔界の王様？ 私の深淵とどちらが深いか、試してみます？', devilhunter: 'フフ、素敵な棺桶ね。でも深淵の底には持ち込めませんわよ？', witch: '時を駆ける少女……フフ、深淵には時間の概念なんてありませんわよ？', oni: 'あら、ご自身の中の鬼を恐れているの？ 深淵に身を委ねれば、楽になりますわよ。', default: 'フフフ……深淵の理に触れる覚悟はありまして？' },
            win: { android: 'あら、壊れちゃいました。', dragon: '沈みなさい、暗い海の底へ。', knight: '狂気に歪むその顔、素敵ですわ。', elf: '過去を探して深淵を彷徨う……。最高の悲劇ですわ。', cleric: 'フフフ、絶望の色に染まったその服……よくお似合いですわよ？', satan: 'フフフ、魔王の絶望する顔……最高の極上ですわ。', devilhunter: 'さぁ、貴方も棺桶ごと深淵へ沈みましょう？', witch: '永遠の時間を、深淵の底で過ごすがいいですわ。', oni: '封印など無駄ですわ。貴方の中の鬼も、深淵が美味しくいただきましたわ。', default: 'アハハハ！ 貴方のSAN値、もう空っぽですわよ？' },
    ...
    elf: {
        ...
        dialogue: {
            intro: { android: 'あなたが動く理由は……命令だけなの？ 少し、共鳴するものがあるわ。', dragon: 'その荒ぶる炎……少し静めてあげましょうか。', knight: '迷いのない剣撃……。私には眩しすぎる。', cthulhu: '貴女は何者……。一体何を知っているの……？', cleric: 'あなたは神に仕える身でありながら、ひどく淀んだ気を纏っているのね。', satan: '魔王サタン……。あなたが、私の記憶を奪ったの？', devilhunter: 'その棺桶……なぜか嫌な予感がするわ。近づかないで。', witch: '時間を渡る魔女……あなたなら、私の過去を知っているの？', oni: 'あなたも、自分の中に抱えるものと戦っているのね……。', default: '……私の邪魔をしないで。矢を放つ準備はできているわ。' },
            win: { android: '壊してしまって……ごめんなさい。', dragon: '炎が消えた……。これで少しは涼しくなるわね。', knight: '誇りを守り抜いたわ……。少し、羨ましい。', cthulhu: '深淵は、私の矢までは飲み込めなかったようね。', cleric: '神の名を騙っても、私の矢の真実は歪められないわ。', satan: 'これで……少しは思い出せるのかしら。', devilhunter: '私は、あなたの獲物にはならないわ。', witch: 'あなたの落とした時間の中に、私の記憶があるかしら……。', oni: 'あなたの術は、私を縛れなかった。……ごめんなさい。', default: 'これが……私の力？ 少しだけ、何かを思い出した気がする。' },
    ...
    devilhunter: {
        ...
        dialogue: {
            ...
            win: { android: 'ただのスクラップね。資源回収にでも回すわ。', dragon: '全く…。ジャケットが少し焦げちゃったわ。', knight: '堅いだけで隙だらけよ。甘いわね。', cthulhu: '海鮮は嫌いじゃないけど、アンタはパス。', elf: '安らかに眠りなさい。夢の中で過去を探すといいわ。', cleric: '祈る暇も無かったみたいね。可哀想に。', satan: '魔王の魂……極上のコレクションが一つ増えたわ。', witch: 'あまり騒ぐと棺桶にぶち込むわよ。大人しくしてなさい。', oni: '札を投げるより、引き金を引く方が早かったわね。', default: "塵一つ残さない……それが私の仕事だから。" },
    ...
    satan: {
        ...
        dialogue: {
            intro: { android: 'ほう、矮小なる人間がここまで辿り着くとはな。我は魔王サタン……絶望の淵へ沈むがよい。', dragon: '竜族の小娘か。その程度の炎で我が玉座を脅かすつもりか？', knight: '聖なる光など、我が魔力の前には風前の灯。', cthulhu: '深淵の使いか……。我に挑むというのか、浅はかな。', elf: '森の迷い子が、死に場所を求めてやって来たか。', cleric: '神を騙る偽善者め。その傲慢さごと握りつぶしてやろう。', devilhunter: '我を狩るだと？ 面白い。その小さな鉄屑で何ができる？', witch: '因果の果てから来たか。何度時を戻そうと、我の絶望に平伏すがよい。', oni: '鬼の血を引く者よ、我に仕えよ。さすればその血の渇き、癒してやろう。', default: "ほう、矮小なる人間がここまで辿り着くとはな。我は魔王サタン……絶望の淵へ沈むがよい。" },
            win: { android: '機械風情が魔王に勝てるわけがなかろう。', dragon: '鱗ごと焼きすり潰してやったわ。', knight: 'その薄っぺらい信念と共に散るがいい。', cthulhu: 'おのれの深淵ごと、我が闇に飲み込まれよ。', elf: '過去を持たぬ者よ、未来も失うがいい。', cleric: '偽りの神に助けは来なかったな。', devilhunter: '身の程を知れ、小娘。その棺桶は自らのために使うのだな。', witch: '時間を弄る程度の魔女が、この魔王に勝てるわけがなかろう。', oni: '所詮は半端者。魔王の絶望を封じることなどできぬわ。', default: "フ……所詮はその程度か。我が糧となるが良い。" },
