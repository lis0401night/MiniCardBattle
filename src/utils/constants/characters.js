  ...
  dragon: {
    ...
    dialogue: {
      intro: {
        ...
        succubus:
          'あんたがヴィオラね！ サタン様の側近だからって、女王様気取りはムカつくのよ！ 私の炎で黒焦げにしてやるんだから！',
        warlock:
  ...
  knight: {
    ...
    dialogue: {
      intro: {
        ...
        warlock:
          '100年前に王国の守護者と呼ばれた伝説の賢者が、なぜ生贄を貪る邪教の主などに！ 騎士の誇りに懸けて君を討つ！',
      },
      win: {
        android: '見事な剣筋だった。',
        dragon: '少しは懲りたか。',
  ...
  elf: {
    ...
    dialogue: {
      ...
      win: {
        ...
        warlock:
          'あなたの魔術はとても悲しい魔術ね。私の銀の矢で、その歪んだ命を射抜かせていただきました。',
      },
      lose: {
  ...
  oni: {
    ...
    dialogue: {
      intro: {
        ...
        succubus:
          '淫らな術で人の心を奪うサキュバスの女王。その強烈な邪気、急急如律令！ ここで絶ち切ります！',
        warlock:
      ...
      win: {
        ...
        warlock:
          '急急如律令！ 多くの生贄の命を奪い繋ぎとめた歪んだ魔力、我が陰陽の符で霧散させ、浄化いたしました。',
      },
      lose: {
