...
export const LEADER_SKILLS = {
  ...
  seal_lanes: {
    name: '急急如律令',
    desc: '(SP:5) 相手のレーンを2つまで選択する。そのレーンのカードに4ダメージを与え、レーンを1ターン封印（召喚・配置・移動不可）する。',
    cost: 5,
    action: 'seal_lanes',
  },
  tomb_guard: {
  ...
  valkyria_guard: {
    name: '戦乙女の加護',
    desc: '(SP:4) 次の自分のターン開始時まで、自分のカードは破壊されず、リーダーとカードが受ける全てのダメージを0にする。',
    cost: 4,
  ...
  otherworld_gate: {
    name: '異界の扉',
    desc: '(SP:3) 手札からカードを最大2枚捨てて同数引き、手札すべてのパワーを+2する。相手の手札からランダムに2枚を捨て、同数「虚空(P:0)」を加える。',
    cost: 3,
  ...
  night_parade: {
    name: '百鬼夜行',
    desc: '(SP:3) 相手のレーンを2つまで選択する。そのレーンのカードに4ダメージを与え、レーンを1ターン封印（召喚・配置・移動不可）する。自分の場に「人魂（パワー1）」を1体配置する。',
    cost: 3,
    action: 'night_parade',
  },
  death_judgment: {
