...
export const TOURNAMENT_CHARACTER_DIALOGUES = {
  android: {
    ...
    postMatch: {
      1: ['初戦突破、おめでとうございます！ 先輩のプレイング、完璧でした！', 'この調子で次もどんどん勝ち進みましょうね！'],
      2: ['第2回戦も難なくクリアですね！ さすが先輩です！', 'でも油断は大敵です。次の相手はもっと強いはずですから！'],
      3: ['準決勝も突破……すごいです、先輩！', '次はいよいよ決勝……全力で挑みましょう！ 私も全力でサポートします！'],
  ...
  dragon: {
    intro: [
      'いよいよカードゲームの全国大会ね！ アタシのギターみたいに、ガンガン攻めていくわよ！',
      'アンタもアタシのビートにしっかりついてきなさいよね！',
    ],
    venue: [
    ...
    postMatch: {
      1: ['あっはっは！ アタシたちのリズムに全然乗れてなかったわね！', 'このまま一気に駆け上がるわよ！ テンション上げてこ！'],
      2: ['少しは骨のある相手だったけど、アタシの爆音ビートには敵わないわ！', 'ここからが本番よ！ もっとボリューム上げていくわよ！'],
      3: ['やったわ！ 次で決勝進出ね！', 'アタシのテンション、もう最高潮よ！ このまま一気に優勝しちゃうわよ！'],
  ...
  knight: {
    ...
    postMatch: {
      1: ['まずは一本！ 立派な勝利だ。', '次の相手も全力で迎え撃つ。気を緩めるな！'],
      2: ['良き手筋だった。対戦相手の健闘にも敬意を。', 'だが、ここからが真の勝負。さらに剣を研ぎ澄ませよう。'],
      3: ['見事だ……この一戦、我が剣道の精神に通じるものがあった。', '決勝への道が開けたぞ。最後まで正々堂々、全力を尽くそう！'],
  ...
  cthulhu: {
    ...
    postMatch: {
      1: ['うふふ……儀式が効いたみたいね。あっけなかったわ。', 'もっと強い相手がいないかしら？ 次の実験台が楽しみだわ。'],
      2: ['いい顔をしていたわ……敗北の恐怖に歪む顔、嫌いじゃないわよ。', '次の相手にはもっと強力な呪いをかけてあげましょう。'],
      3: ['これで決勝進出ね。学園七不思議の力、まだまだこんなものじゃないわよ。', '最後の儀式……最大級のものを用意してあるわ。楽しみにしていなさい？'],
  ...
  elf: {
    ...
    postMatch: {
      1: ['初戦、無事に勝ててよかったわ。相手の子、泣いてなかったかしら？', 'まだ先は長いけど……一歩ずつ、進みましょう。'],
      2: ['だんだん相手が強くなってきてる気がする……。', 'でも大丈夫。ウサギさんのように軽やかにいきましょう！'],
      3: ['ここまで来れたなんて信じられない……。', 'あと少しよ……最後まで一緒に頑張りましょう！'],
  ...
  cleric: {
    ...
    postMatch: {
      1: ['当然の結果ね。私に指導されたあなたが負けるはずないでしょう。', '次の相手にも、私の教育の成果を思い知らせてあげるわ！'],
      2: ['相手のプレイング、甘すぎるわ。当然の勝利ね！', 'でも次はもう少し手強いはずよ。油断したら許さないわよ。'],
      3: ['いよいよ準決勝も突破ね。', 'ここまできたら優勝以外は許さないわよ！ 最後まで気を抜かないで！'],
  ...
  devilhunter: {
    ...
    postMatch: {
      1: ['ま、こんなもんね。楽勝すぎてもうあくびが出そう。', 'さっさと次行くわよ。時間の無駄は嫌いなの。'],
      2: ['少しは骨のある奴が出てきたみたいね。でもアタシの敵じゃないわ。', 'まだまだ余裕ね。次の奴も同じ目に遭わせてあげる。'],
      3: ['フン、ここまで来ると相手もそれなりってことね。', '次で決勝？ ちゃっちゃと片付けて賞金もらうわよ。'],
  ...
  witch: {
    ...
    postMatch: {
      1: ['えっ、勝っちゃったんですか？ ……まあ、適当にやっても勝てるレベルですね。', 'もう帰りましょうよ……まだ続くんですか？'],
      2: ['はぁ……まだ終わらないんですね。面倒くさ……。', '……まあ、ここまで来たら適当に最後まで付き合ってあげますよ。'],
      3: ['まだ続くんですか！？ 本当に面倒くさいです……！', '……でも、ここまで来ちゃったし……負けるのも癪ですね。'],
  ...
  oni: {
    ...
    postMatch: {
      1: ['服装の乱れは心の乱れ！ プレイングにも迷いが見えましたね。', '次の対戦でも、正々堂々の精神で臨みます！'],
      2: ['見事なマナーでしたが、私には及びません。', 'この大会、風紀を正すいい機会です。次も全力で参ります！'],
      3: ['正義は必ず勝つのです！ 準決勝も突破しました！', '決勝の舞台……全校の模範となるような戦いを見せましょう！'],
      default: ['次の試合も、油断せずいきましょう。', 'ルールを守り、正々堂々と！'],
    },
    win: [
  ...
  priest: {
    ...
    postMatch: {
      1: ['……勝てた……。日本のプレイヤー、強い……。', '……でも、まだ……負けない……。'],
      2: ['……カードのコンボ……すごく勉強になる……。', '……次も、頑張る……あなたと一緒に……。'],
 ...
 */
export function getTournamentPostBattleAnnounce(round, playerWon, playerConfig, enemyConfig) {
