...
export const TOURNAMENT_CHARACTER_DIALOGUES = {
  ...
  valkyria: {
    intro: [
      'カードゲームの全国大会？ ふんっ、アタシにかかれば楽勝に決まってるじゃない！ 陸上でもカードでもエリートはエリートなんだから！',
      'アンタはアタシの足を引っ張らないようにしなさいよね！ ……べ、別にアンタと組めて嬉しいとか思ってないんだからね！',
    ],
    venue: [
      'うわっ、すっごい人……！ ……な、なによ、べ、別にビビってなんかないわよ！ アタシはエリートなんだから、この程度で動じるわけないでしょ！',
      'さっさと全員ぶっ倒して優勝かっさらうわよ！ アタシについてきなさい！',
    ],
    postMatch: {
      1: [
        'はっ、余裕すぎて欠伸が出そうだったわ！ エリートの実力、ちょっとは分かったかしら！',
        'ほら、ボーッとしてないで次の準備！ アタシは待つの嫌いなのよ！',
      ],
      2: [
        'はぁ？ まだこの程度の相手しか出てこないの？ アタシのエリートっぷりを見せつける暇もないじゃない！',
        '……ま、まあ、さっきよりはちょっと手応えあったけど。次はもっと強いの来なさいよね！',
      ],
      3: [
        'やっ……やったわ！ 決勝進出よ！ ほ、ほらね！ アタシがエリートだって言ったでしょ！',
        '……あと1回……。ここまで来たんだから、優勝以外ありえないわよ！ 気合い入れなさい、アンタ！',
      ],
      default: [
        'ふんっ、アタシの敵じゃなかったわね！',
        'モタモタしてないで次行くわよ！ 優勝まで止まらないんだから！',
      ],
    },
    win: [
      'ゆ、優勝……アタシたちが優勝したのよ！！ ほらぁ！ アタシがエリートだって証明されたじゃない！！',
      '……うっ……目から汗が……。な、泣いてなんかないわよ！ 嬉しくて体温上がっただけなんだから……！ ……アンタのせいよ、全部アンタのせい……！',
    ],
  },
};
