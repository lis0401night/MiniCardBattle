...
export const CHALLENGE_EXCHANGE_LINEUP = [
    ...
    { id: 'pm_android_summer', type: 'playmat', name: '水陸両用装備', description: '研究所より支給された耐熱・耐水処理を施した特殊換装とのこと。', cost: 20 },
    { id: 'pm_dragon_summer', type: 'playmat', name: '真夏の焔竜姫', description: '太陽の熱よりも熱い竜の息吹。水辺でも彼女の炎が消えることは決してない。', cost: 20 },
    { id: 'pm_knight_summer', type: 'playmat', name: '波打ち際の騎士', description: '鎧を脱ぎ捨て、ひとときの休息を楽しむ騎士。その剣腕は水着姿でも少しも鈍らない。', cost: 20 },
    { id: 'pm_cthulhu_summer', type: 'playmat', name: '深海のサマースイム', description: '深淵から現れた名状しがたき水着姿。彼女が泳ぐたび、波間に狂気が蠢くという。', cost: 20 },
    { id: 'pm_elf_summer', type: 'playmat', name: '水辺の流浪者', description: '森を抜け出し、海辺にやってきた流浪のエルフ。波の音に耳を傾ける穏やかな時間。', cost: 20 },
    { id: 'pm_cleric_summer', type: 'playmat', name: '背徳のサマーバカンス', description: '神職の務めを忘れ、開放的な夏を満喫する聖職者。神の慈悲は海よりも広いらしい。', cost: 20 },
    { id: 'pm_devilhunter_summer', type: 'playmat', name: '渚の悪魔狩り', description: '悪魔を狩るのも夏休みが必要だ。ただし、銃の手入れだけは怠らない。', cost: 20 },
    { id: 'pm_witch_summer', type: 'playmat', name: '不機嫌なサマー・グリモワール', description: '無理矢理取らされた夏休み。慣れない水着と照りつける太陽のせいで、全く読書に集中できていないようだ。', cost: 20 },
