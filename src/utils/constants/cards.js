...
export const CARD_MASTER = [
    ...
    { id: 'incinerator', name: 'インシネレーター', power: 3, skill: 'artillery', skillValue: 1, rarity: 2, voiceCategory: 'human_female_cool', flavor: '異端の書物、教義に背く者を炎で浄化する実働部隊。マスク越しの彼女の瞳に、慈悲の色はない。' },
