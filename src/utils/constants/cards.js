...
export const CARD_MASTER = [
    ...
    { id: 'beginnermagic', name: '初級魔術', rarity: 1, voiceCategory: 'magic', power: 0, skill: 'choice', skillValue: 1, choices: [{ id: 'summon', value: 5 }, { id: 'heal', value: 5 }], flavor: '大地に流れる脈動をマナへと変換する基礎的な魔術。' },
    ...
    { id: 'hero', name: '若き勇士', power: 2, skill: 'hero', skillValue: 2, voiceCategory: 'human_female_young', rarity: 2, flavor: '安物の胸当てに、誇りと希望だけを詰め込んだ新米訓練兵。その不器用な剣筋も、いつか伝説へと連なる。' },
    ...
    { id: 'bear', name: '森の恐怖', power: 2, skills: [{ id: 'pierce' }, { id: 'lone_wolf', value: 2 }], rarity: 2, voiceCategory: 'bear', flavor: '禁域に迷い込んだ愚か者に与えられるのは、警告ではない。ただ前触れなき蹂躙のみである。' },
    ...
    { id: 'plaguedoctor', name: '烏羽の医師', power: 2, rarity: 2, skills: [{ id: 'choice', value: 1 }], choices: [{ id: 'heal', value: 2 }, { id: 'toxic', value: 2 }], voiceCategory: 'human_female_ikemen', flavor: '彼女の処方箋は、明日を繋ぐ特効薬か、あるいは安息へと誘う安楽死の劇薬か' },
    ...
    { id: 'gargoyle', name: 'ガーゴイル', rarity: 2, voiceCategory: 'sword', power: 6, skills: [{ id: 'sturdy' }, { id: 'standby', value: 1 }], flavor: '塔の頂から見下ろす冷たい石の瞳。夜の帳が下りる時、それは獲物を狙う狩人となる。' },
    { id: 'battlemage', name: 'ギルドの戦闘魔導士', rarity: 2, voiceCategory: 'human_male_warrior', power: 4, skills: [{ id: 'convert', value: 1 }, { id: 'snipe', value: 4 }], flavor: '剣と魔法を操る魔導士。彼らが招集されたということは、困難な任務であることを意味する' },
    ...
    { id: 'djinn', name: '願いの魔神', rarity: 3, voiceCategory: 'daemon', power: 1, skills: [{ id: 'legendary' }, { id: 'convert', value: 3 }, { id: 'choice', value: 3 }], choices: [{ id: 'heal', value: 2 }, { id: 'draw', value: 2 }, { id: 'spread', value: 2 }, { id: 'snipe', value: 4 }, { id: 'lone_wolf', value: 2 }, { id: 'support', value: 2 }], flavor: '3つの願いを叶えるランプの魔人' },
    { id: 'book', name: '禁書目録', rarity: 3, voiceCategory: 'magic', power: 0, skills: [{ id: 'convert', value: 1 }, { id: 'choice', value: 1 }], choices: [{ id: 'resurrect', value: 6 }, { id: 'morph', value: 4 }], flavor: '禁じられた秘術が記された本。ページを捲るたび、正気は失われ、深淵の知識が魂を蝕んでいく。それでも力に飢えるなら、開くがいい。' },
    ...
    { id: 'redhood', name: 'レッドフード', power: 3, rarity: 3, skills: [{ id: 'legendary' }, { id: 'choice', value: 1 }], choices: [{ id: 'snipe', value: 5 }, { id: 'spread', value: 1 }], voiceCategory: 'human_female_ikemen', flavor: '赤い頭巾に隠された鋭い眼光。彼女のクロスボウから放たれる矢は、森の静寂を破ることなく標的の心臓を射抜く。' },
    { id: 'queen', name: '嫉妬の女王', power: 4, rarity: 3, skills: [{ id: 'legendary' }, { id: 'choice', value: 1 }], choices: [{ id: 'draw', value: 3 }, { id: 'deadly' }], voiceCategory: 'human_female_ikemen', flavor: '”世界で一番美しいのは誰？”——その問いに答える者がいなくなるまで、ただ愚か者を狩り尽くすのみ。' },
