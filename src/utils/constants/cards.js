...
export const CARD_MASTER = [
    ...
    { id: 'hammer', name: '雷神の鎚', power: 3, rarity: 2, skills: [{ id: 'equip' }, { id: 'snipe', value: 3 }, { id: 'salvage', value: 1 }], voiceCategory: 'stone', flavor: '天の怒りを顕現せし剛雷の戦鎚。主の呼応に応じて雷鳴と共に飛来し、万物を等しく打ち砕く。' },
    ...
    { id: 'graverobber', name: '優雅な墓荒らし', power: 4, rarity: 3, skills: [{ id: 'legendary' }, { id: 'choice', value: 1 }], choices: [{ id: 'salvage' }, { id: 'resurrect', value: 3 }], voiceCategory: 'female_ikemen', flavor: '朽ちた墓石を踏み躙り、泥に塗れたドレスを優雅に翻す。彼女にとって死者の尊厳など、土に眠る財宝の輝きには遠く及ばないのだ。' },
