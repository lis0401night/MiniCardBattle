...
export const CARD_MASTER = [
  ...
  },
  {
    ...
    rarity: 1,
    power: 4,
    skills: [{ id: 'servant', value: 1, summonId: 'token_drone' }],
  ...
  },
  {
    ...
    rarity: 1,
    power: 3,
    skills: [{ id: 'servant', value: 2, summonId: 'token_knight' }],
    voiceCategory: 'human_male_ikemen',
    flavor:
  ...
  },
  {
    ...
    choices: [
      { id: 'servant', value: 5, summonId: 'token_ent' },
      { id: 'heal', value: 5 },
    ],
    voiceCategory: 'magic',
    flavor:
  ...
  },
  {
    ...
    skills: [{ id: 'choice', value: 1 }],
    choices: [
      { id: 'servant', value: 5, summonId: 'token_golem' },
      { id: 'support', value: 3 },
    ],
    voiceCategory: 'magic',
  ...
  },
  {
    ...
    choices: [
      { id: 'servant', value: 7, summonId: 'token_daemon' },
      { id: 'cull', value: 2 },
    ],
    voiceCategory: 'magic',
  ...
  },
  {
    ...
    skills: [
      { id: 'seal', value: 1 },
      { id: 'servant', value: 1, summonId: 'token_soul' },
    ],
    voiceCategory: 'undead',
    flavor:
  ...
  },
  {
    ...
    skills: [
      { id: 'convert', value: 2 },
      { id: 'servant', value: 6, summonId: 'token_dragon' },
      { id: 'berserk', value: 2 },
    ],
    voiceCategory: 'human_male_normal',
    flavor:
  ...
  },
  {
    ...
    skills: [
      { id: 'legendary' },
      { id: 'sacrifice', value: 3 },
      { id: 'servant', value: 3, summonId: 'token_skeleton' },
      { id: 'choice', value: 1 },
    ],
  ...
  },
  {
    ...
    skills: [
      ...
      { id: 'servant', value: 3, summonId: 'token_whitewolf' },
      { id: 'arm_self' },
    ],
    voiceCategory: 'human_female_normal',
    flavor:
  ...
  },
  {
    ...
    power: 4,
    skills: [{ id: 'supremacy' }],
    supremacySkills: [{ id: 'buff', value: 4 }],
    voiceCategory: 'human_male_warrior',
    flavor:
      '帝国の精鋭兵。強大なる覇者の威光を背に受ける時、その剣は更なる力を宿す。',
  },
  {
    id: 'enlisteddragon',
    obtain: [],
    ...
    voiceCategory: 'dragon',
    flavor:
      '帝国の軍門に降った巨竜。枷でその力を封じられているが、大いなる覇者の咆哮に応じ、真の力を解放する。',
  },
  {
    id: 'mercenaryleader',
    obtain: [],
    ...
    rarity: 2,
    power: 5,
    skills: [{ id: 'legendary' }, { id: 'call', targetKeyword: '傭兵' }],
    voiceCategory: 'human_male_warrior',
    flavor:
      '傭兵たちを束ねる百戦錬磨の隊長。その号令一つで、歴戦の兵たちが戦場へと駆けつける。',
  },
  {
    id: 'mercenarycamp',
    obtain: [],
  ...
  },
  {
    ...
    rarity: 2,
    power: 3,
    skills: [{ id: 'heal', value: 2 }, { id: 'guardian' }, { id: 'sturdy' }],
    voiceCategory: 'sword',
    flavor:
      '滅びの灰に塗れてなお、その祈りは濁らない。西の残光を背に受けて立つ姿は、人々に残された唯一の希望である。',
  },
  {
    id: 'angelpray',
    obtain: [],
    ...
    skills: [{ id: 'legendary' }, { id: 'choice', value: 1 }],
    choices: [
      { id: 'servant', value: 7, summonId: 'token_angel' },
      { id: 'heal', value: 7 },
    ],
    voiceCategory: 'magic',
    flavor: '',
  },
  {
    ...
    voiceCategory: 'undead',
    flavor:
      '森をさまよう狩人の霊。生前の執念が、死の淵から何度でもその弓を引き絞らせる。',
  },
  {
    id: 'ghoul',
    obtain: [],
  ...
  },
  {
    ...
    rarity: 3,
    power: 0,
    skills: [{ id: 'assemble', targetKeyword: '神官' }],
    voiceCategory: 'stone',
    flavor: '',
  },
  {
  ...
  },
  {
    ...
    rarity: 3,
    power: 4,
    skills: [{ id: 'defender' }, { id: 'startup' }, { id: 'choice', value: 1 }],
    choices: [{ id: 'buff', value: 6 }, { id: 'unleash' }],
    voiceCategory: 'machine_new',
    flavor: '',
  },
  {
  ...
  },
  {
    ...
    skills: [
      ...
      {
        id: 'summon',
        targetIds: ['redhood', 'snowwhite', 'goldilocks', 'rosenberg'],
        excludeBoard: true,
      },
      {
        id: 'resurrect',
