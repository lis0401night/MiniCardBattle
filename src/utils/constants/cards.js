...
export const CARD_MASTER = [
    ...
    { id: 'bear', name: '森の恐怖', power: 2, skills: [{ id: 'pierce' }, { id: 'lone_wolf', value: 2 }], rarity: 2, voiceCategory: 'beast', flavor: '禁域に迷い込んだ愚か者に与えられるのは、警告ではない。ただ前触れなき蹂躙のみである。' },
    ...
    { id: 'mage', name: '学院の雷撃魔導士', power: 2, skill: 'spread', skillValue: 2, rarity: 2, voiceCategory: 'human_female_cool', flavor: '魔導アカデミーの雷撃魔導士。周囲の魔力を吸収し、雷撃を放つ。' },
