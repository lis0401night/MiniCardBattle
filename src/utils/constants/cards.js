...
export const CARD_MASTER = [
    ...
    { id: 'necromancer', name: 'ヴィス・ガルドの背教者', power: 2, skill: 'resurrect', skillValue: 4, rarity: 1, voiceCategory: 'human_female_ikemen', imgUrl: 'assets/cards/card_necromancer.jpg', flavor: '『さあ、起きなさい…永遠なる奉仕の時間が始まるわ』。真紅の瞳が見つめる先、死者は再び立ち上がる。' },
    { id: 'goat', name: 'スケープゴート', power: 2, rarity: 1, skills: [{ id: 'sacrifice', value: 3 }, { id: 'charge', value: 2 }], voiceCategory: 'beast', flavor: '不吉な儀式の供物として捧げられる山羊。その命が尽きる時、主には強大な魔力が還元される。' },
    { id: 'devil', name: '地獄の放火魔', power: 2, skills: [{ id: 'spread', value: 3 }, { id: 'explode', value: 3 }], rarity: 1, voiceCategory: 'beast', flavor: '背中のタンクには地獄の業火が詰まっている。初めて武器を与えられた小悪魔は、その焦熱を振り撒くことに至上の喜びを感じていた。' },
    ...
    { id: 'prince', name: '星の王子', power: 1, skill: 'stealth', skillValue: 2, rarity: 2, voiceCategory: 'lizard', flavor: '黒き触手に抱かれた幼き王は、遥か宇宙の深淵から、我らの空へと帰還しつつある。' },
    ...
    { id: 'monk', name: '野営地の衛生兵', power: 3, skills: [{ id: 'sturdy' }, { id: 'heal', value: 1 }], rarity: 2, voiceCategory: 'human_male_warrior', imgUrl: 'assets/cards/card_monk.jpg', flavor: '神の加護と鋼の肉体を持つ僧兵。その癒しの手は味方を救い、時に果敢な一撃は敵を砕く。' },
    { id: 'incinerator', name: 'インシネレーター', power: 3, skill: 'artillery', skillValue: 1, rarity: 2, voiceCategory: 'human_female_ikemen', imgUrl: 'assets/cards/card_incinerator.jpg', flavor: '異端の書物、教義に背く者を炎で浄化する実働部隊。マスク越しの彼女の瞳に、慈悲の色はない。' },
    ...
    { id: 'zombie', name: '解き放たれた囚人', power: 1, skills: [{ id: 'clone', value: 2 }, { id: 'growth', value: -1 }], rarity: 2, voiceCategory: 'undead', flavor: 'かつて地下牢に繋がれていた者たちの成れの果て。その怨念は果てることなく、仲間を呼び寄せながら朽ちてゆく。' },
    { id: 'franken', name: 'オールドヘイヴンの怪物', power: 8, skill: 'standby', skillValue: 1, rarity: 2, voiceCategory: 'giant', imgUrl: 'assets/cards/card_franken.jpg', flavor: '見捨てられた街の地下深くに眠る禁断の造物。動き出せば、その怪力で全てを粉砕する。' },
    ...
    { id: 'assassin', name: 'ギルドの暗殺者', power: 1, skills: [{ id: 'quick' }, { id: 'deadly' }, { id: 'stealth', value: 1 }], rarity: 3, voiceCategory: 'human_female_assassin', flavor: '黒い服と2つの短剣を持つ若い女暗殺者。一瞬の隙も逃さず、死の影から獲物を屠る。' },
    ...
    { id: 'fire', name: '浄化の炎', power: 6, skills: [{ id: 'artillery', value: 3 }, { id: 'defender' }, { id: 'guardian' }], rarity: 3, voiceCategory: 'machine_old', imgUrl: 'assets/cards/card_fire.jpg', flavor: '異端を焼き払う神聖なる十字。その盾は信徒を守り、砲口は敵への裁きを下す。' },
    { id: 'collector', name: 'ヘッドコレクター', power: 1, skills: [{ id: 'legendary' }, { id: 'sacrifice', value: 3 }, { id: 'resurrect', value: 9 }, { id: 'deadly' }], rarity: 3, voiceCategory: 'undead', imgUrl: 'assets/cards/card_collector.jpg', flavor: '集められた数多の魂が慟哭を上げる。彼の者が通り過ぎた後には、首のない骸だけが残される。' },
