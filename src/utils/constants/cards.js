...
export const CARD_MASTER = [
    ...
    { id: 'book', name: '禁書目録', rarity: 3, voiceCategory: 'magic', power: 0, skills: [{ id: 'convert', value: 1 }, { id: 'choice', value: 1 }], choices: [{ id: 'charge', value: 3 }, { id: 'morph', value: 4 }], flavor: '禁じられた秘術が記された本。ページを捲るたび、正気は失われ、深淵の知識が魂を蝕んでいく。それでも力に飢えるなら、開くがいい。' },
