...
export const CARD_MASTER = [
    ...
    { id: 'djinn', name: '願いの魔神', rarity: 3, voiceCategory: 'daemon', power: 1, skills: [{ id: 'legendary' }, { id: 'convert', value: 3 }, { id: 'choice', value: 3 }], choices: [{ id: 'heal', value: 2 }, { id: 'draw', value: 2 }, { id: 'spread', value: 2 }, { id: 'snipe', value: 3 }, { id: 'lone_wolf', value: 2 }, { id: 'support', value: 2 }], flavor: '3つの願いを叶えるランプの魔人' },
