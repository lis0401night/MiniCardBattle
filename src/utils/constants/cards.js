...
export const CARD_MASTER = [
    ...
    { id: 'cleric', name: '見習い修道女', power: 3, skill: 'heal', skillValue: 3, rarity: 1, voiceCategory: 'human_female_cute', flavor: '救済を志し修業に励む乙女。未熟ながらもその祈りは傷ついた心を癒やす。' },
    ...
    { id: 'mercenary', name: '傭兵', power: 6, skill: 'convert', skillValue: 1, rarity: 1, voiceCategory: 'human_male_warrior', flavor: '命が安い戦場において、彼が信じるのは己の腕と報酬だけである。' },
    ...
    { id: 'crenellatedwall', name: '民兵団の射手', power: 8, skills: [{ id: 'spread', value: 1 }, { id: 'defender' }], rarity: 1, voiceCategory: 'human_male_normal', flavor: '故郷を守るために立ち上がった志願兵たち。門の内側から放たれる矢は、侵略者を決して逃さない。' },
    ...
    { id: 'zombie', name: '死蠅の大群', power: 1, skills: [{ id: 'clone', value: 2 }, { id: 'growth', value: -1 }], rarity: 1, voiceCategory: 'insect', flavor: '屍から次々と湧き出し、空を黒く染め上げる不浄の群れ。おぞましい羽音を響かせて増殖する' },
    ...
    { id: 'dreadnought', name: 'ドラゴン・ドレッドノート', power: 10, rarity: 2, skills: [{ id: 'sturdy' }, { id: 'standby', value: 3 }, { id: 'growth', value: -1 }], voiceCategory: 'machine_old', flavor: '純粋な破壊を目的に建造された古代大戦の巨大兵器。冷たい鋼の奥底で重厚な機関音を響かせ、再び空を焦がす再起動の刻を静かに待っている。' },
    ...
    { id: 'hero', name: '若き勇士', power: 4, skill: 'hero', skillValue: 2, voiceCategory: 'human_female_normal', rarity: 2, flavor: '安物の胸当てに、誇りと希望だけを詰め込んだ新米訓練兵。その不器用な剣筋も、いつか伝説へと連なる。' },
    ...
    { id: 'bear', name: '森の恐怖', power: 3, skills: [{ id: 'pierce' }, { id: 'lone_wolf', value: 2 }], rarity: 2, voiceCategory: 'beast', flavor: '禁域に迷い込んだ愚か者に与えられるのは、警告ではない。ただ前触れなき蹂躙のみである。' },
    { id: 'shaman', name: '樫族のシャーマン', power: 3, skill: 'dispel', skillValue: 1, rarity: 2, voiceCategory: 'human_male_warrior', flavor: '彼の呪術は敵の武装を縛り、そして砕く。千年の時を生きる老エルフの瞳には、人の造りし武具など児戯に等しい。' },
    { id: 'bird', name: '新緑の導き鳥', power: 1, skill: 'split', skillValue: 5, rarity: 2, voiceCategory: 'bird', flavor: 'その小さなさえずりが途絶えたとき、森の静寂は怒号へと変わる。' },
    { id: 'prince', name: '星の王子', power: 1, skill: 'stealth', skillValue: 3, rarity: 2, voiceCategory: 'monster', flavor: '黒き触手に抱かれた幼き王は、遥か宇宙の深淵から、我らの空へと帰還しつつある。' },
    ...
    { id: 'copy', name: '虚無の目覚め', power: 4, skill: 'morph', skillValue: 1, rarity: 2, voiceCategory: 'monster', flavor: 'その巨大な眼差しに見つめられた時、存在の意味は虚空へと霧散し、ただ静寂のみが残される。' },
    ...
    { id: 'plaguedoctor', name: '烏羽の医師', power: 3, rarity: 2, skills: [{ id: 'choice', value: 1 }], choices: [{ id: 'heal', value: 2 }, { id: 'toxic', value: 2 }], voiceCategory: 'human_female_cool', flavor: '彼女の処方箋は、明日を繋ぐ特効薬か、あるいは安息へと誘う安楽死の劇薬か' },
    { id: 'servant', name: '吸血鬼の従者', power: 3, rarity: 2, skills: [{ id: 'equip' }, { id: 'soul_bind', value: 2 }], voiceCategory: 'human_female_cool', flavor: '「ふふっ、とても頼もしいお方……どうか私を、貴方様の傍に置いてくださる？」自らの弱さを知る妖艶な吸血鬼は、永遠の夜を生き抜くため、甘い吐息と共に強き者の腕へとすり寄る。' },
    ...
    { id: 'dragonfire', name: 'ドラゴンファイア', rarity: 2, voiceCategory: 'magic', power: 0, skill: 'choice', skillValue: 1, choices: [{ id: 'artillery', value: 2 }, { id: 'snipe', value: 8 }], flavor: '厳重に封印された硝子瓶。中で燻るのは、万物を灰燼に帰す竜王の怒りだ。' },
    { id: 'gargoyle', name: 'ガーゴイル', rarity: 2, voiceCategory: 'stone', power: 5, skills: [{ id: 'sturdy' }, { id: 'standby', value: 2 }], flavor: '塔の頂から見下ろす冷たい石の瞳。夜の帳が下りる時、それは獲物を狙う狩人となる。' },
    ...
    { id: 'champion', name: 'アリーナのチャンピオン', power: 4, skills: [{ id: 'legendary' }, { id: 'hero', value: 3 }], rarity: 3, voiceCategory: 'human_male_warrior', flavor: '観衆の歓声こそが彼の力。その雄姿は味方を鼓舞し、敵を圧倒する。' },
    ...
    { id: 'caller', name: '魔琴の奏者', power: 3, rarity: 3, skill: 'call', skillValue: 3, voiceCategory: 'human_female_cool', flavor: '奏でられるのは森の賛歌か、それとも愚者への鎮魂歌か。ただ確かなのは、その妖しき調べを耳にしたが最後、大いなる森の軍勢から逃れる術はないということだ。' },
    ...
    { id: 'graverobber', name: '優雅な墓荒らし', power: 4, rarity: 3, voiceCategory: 'human_female_normal', skills: [{ id: 'convert', value: 2 }, { id: 'choice', value: 1 }], choices: [{ id: 'salvage', value: 1 }, { id: 'resurrect', value: 3 }], flavor: '朽ちた墓石を踏み躙り、泥に塗れたドレスを優雅に翻す。彼女にとって死者の尊厳など、土に眠る財宝の輝きには遠く及ばないのだ。' },
