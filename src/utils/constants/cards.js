...
export const CARD_MASTER = [
    ...
    { id: 'graverobber', name: '優雅な墓荒らし', power: 4, rarity: 3, skills: [{ id: 'convert', value: 2 }, { id: 'choice', value: 1 }], choices: [{ id: 'salvage', value: 1 }, { id: 'resurrect', value: 3 }], voiceCategory: 'female_ikemen', flavor: '朽ちた墓石を踏み躙り、泥に塗れたドレスを優雅に翻す。彼女にとって死者の尊厳など、土に眠る財宝の輝きには遠く及ばないのだ。' },
