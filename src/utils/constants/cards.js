...
export const CARD_MASTER = [
    ...
    { id: 'chameleon', name: '迷彩カメレオン', power: 3, skill: 'invincible', skillValue: 1, rarity: 1, voiceCategory: 'lizard', flavor: '周囲の景色に完璧に溶け込む擬態能力。じっと潜んだその姿は、どんな熟練の狩人にも見抜くことはできない。' },
