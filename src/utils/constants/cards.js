...
export const CARD_MASTER = [
    ...
    { id: 'mage', name: '学院の雷撃魔導士', power: 5, skills: [{ id: 'sacrifice', value: 3 }, { id: 'growth', value: 3 }], rarity: 2, voiceCategory: 'human_female_ikemen', flavor: '魔導アカデミーの雷撃魔導士。周囲の魔力を吸収し、雷撃を放つ。' },
