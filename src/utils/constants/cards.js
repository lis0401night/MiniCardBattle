...
export const CARD_MASTER = [
    ...
    { id: 'warlock', name: '煉獄の拷問官', power: 4, skills: [{ id: 'sacrifice', value: 4 }, { id: 'berserk', value: 4 }, { id: 'spread', value: 4 }], rarity: 2, voiceCategory: 'devil', flavor: '燃え盛る炎の鞭を振るう魔界の拷問官。その一振りは敵を焼き払い、自らの魂さえも劫火の糧とする。' },
    { id: 'dealer', name: 'デビル・ディーラー', power: 5, skills: [{ id: 'sacrifice', value: 2 }, { id: 'draw', value: 4 }], rarity: 2, voiceCategory: 'devil', flavor: '「さあ、運命を選びな。代償は君の魂で十分だ。」不敵な笑みを浮かべる悪魔の占い師。' },
