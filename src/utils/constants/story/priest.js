  ...
  cthulhu: {
    early: {
      pre: [
        ...
        { speaker: 'player', text: '我が儀式用ナイフをもって……その深淵の闇を切り裂いてみせよう……' }
      ],
      post: [
        { speaker: 'enemy', text: 'あらあら……私の深淵の狂気すら跳ね返すほどの静かなる意志。楽しませていただきましたわ' },
        { speaker: 'player', text: '……ナイア、お前の深淵の狂気、確かに底知れぬ深さだった。' },
    ...
    late: {
      pre: [
        ...
        { speaker: 'enemy', text: 'でも私の狂気は、この痛みさえも極上の快楽に変えてしまいますのよ' },
        { speaker: 'player', text: '……狂気に身を任せて破滅するなど、見過ごせん。' },
        { speaker: 'player', text: '我が儀式用ナイフをもって……その狂熱を冷ましてやる……！' }
      ],
      post: [
  ...
  elf: {
    early: {
      pre: [
        ...
        { speaker: 'player', text: 'その星墜ちの矢の鋭さ、我が儀式用ナイフで迎え撃とう……' }
      ],
      post: [
    ...
    late: {
      pre: [
        ...
        { speaker: 'enemy', text: 'だから、どんなにボロボロになったって、私の弓は引き絞れる！' },
        { speaker: 'player', text: '……使命のために命を散らすなど、愚の極み。' },
        { speaker: 'player', text: '我が古代の呪縛をもって……お前のその震える両腕を縛り付ける……！' }
      ],
      post: [
        { speaker: 'enemy', text: 'ああっ……！ 弓を引く腕の筋肉が、もう言うことを聞かない……。' },
  ...
  cleric: {
    early: {
      pre: [
        ...
        { speaker: 'player', text: 'お前のその鉄の十字架とメイスで、身をもって確かめるがいい……' }
      ],
      post: [
        { speaker: 'enemy', text: 'はぁ！？ あり得ないわ！ 私の神罰のメイスが、そんな呪縛の壁に弾き返されるなんて……！' },
        { speaker: 'player', text: '……エリシア、お前のメイスの打撃、なかなかの剛力だった。' },
    ...
    late: {
      pre: [
        ...
        { speaker: 'enemy', text: 'はぁ！？ 私が瘴気ごときに負けるわけないでしょ！ ' },
        { speaker: 'enemy', text: 'さっさとそこをどきなさい、古代人！' },
        { speaker: 'player', text: '……己の限界さえ見誤る強欲、ここで断ち切る。' },
        { speaker: 'player', text: '我が古代の呪縛をもって……お前の荒ぶる妄執を鎮めてやる……！' }
      ],
      post: [
  ...
  devilhunter: {
    early: {
      pre: [
        ...
        { speaker: 'player', text: '我が儀式用ナイフと呪縛の刃、その身で味わえ……' }
      ],
      post: [
    ...
    late: {
      pre: [
        ...
        { speaker: 'enemy', text: 'その満身創痍の身体を引きずってでも、魔王城へ乗り込んでやるさ！' },
        { speaker: 'player', text: '……死に急ぐ猟犬など、見るに堪えん。' },
        { speaker: 'player', text: '我が古代呪縛をもって……お前のその頑なな足を封じる……！' }
      ],
      post: [
  ...
  witch: {
    early: {
      ...
      post: [
        ...
        { speaker: 'player', text: '……クロエ、お前の時間逆行の魔術、恐るべきものだった。' },
    ...
    late: {
      pre: [
        ...
        { speaker: 'enemy', text: 'でも、ここで居残りをやめて引き下がるわけにはいかないんです！' },
        { speaker: 'player', text: '……脳が焼き切れて死に至るなど、ただの愚行だ。' },
        { speaker: 'player', text: '我が儀式用ナイフをもって……お前の時間を一時停止する……！' }
      ],
      post: [
  ...
  oni: {
    early: {
      pre: [
        ...
        { speaker: 'player', text: '……フッ、お前のその強い瞳……嫌いではない。手加減はしない。' },
        { speaker: 'player', text: '来い、カグラ……！' }
      ],
      post: [
        { speaker: 'enemy', text: 'ネフティ殿のナイフの冴え、実に見事なものでした。お互い、旅を続けましょう' },
        { speaker: 'player', text: '……カグラ、お前の符と結界の冴え、実に見事だった。' },
    ...
    late: {
      pre: [
        ...
        { speaker: 'player', text: '我が儀式用ナイフをもって……お前のその頑なな魂を鎮める……！' }
      ],
      post: [
        { speaker: 'enemy', text: 'ハァ、ハァ……お札を握る指さえも、もう……。' },
        { speaker: 'enemy', text: '世界の平穏を、お任せするしかありませんか……' },
  ...
  priest: {
    early: {
      pre: [
        ...
        { speaker: 'enemy', text: '……手加減は無用だ。古代呪縛の魔力、どちらが真に墓守の資格を持つか……' },
        { speaker: 'enemy', text: '白黒つけよう……' },
        { speaker: 'player', text: '……望むところだ。王墓に眠るすべての呪縛にかけて、' },
        { speaker: 'player', text: '本物の守護の力をお前に刻み込む……！' }
      ],
      post: [
        { speaker: 'enemy', text: '……王墓の呪縛さえも凌駕するナイフの冴えか……。' },
        { speaker: 'enemy', text: '私の負けだ。その術、見事だった……' },
        { speaker: 'player', text: '……お前の古代呪縛の冴え、実に見事だった。私自身の力、再認識した。' },
    ...
    late: {
      pre: [
        ...
        { speaker: 'enemy', text: '我が命の灯が消える前に、魔王の息の根を止めれば、王墓の役目は果たされる……！' },
        { speaker: 'player', text: '……死を前提とした役目など、王墓は望まない。' },
        { speaker: 'player', text: '私自身だからこそ、その無謀な消滅は阻止する……！' }
      ],
      post: [
        { speaker: 'enemy', text: '……ぐ、はっ……！ 呪縛の侵食が……肉体の限界か……。' },
  ...
  shadow: {
    early: {
      pre: [
        ...
        { speaker: 'player', text: '我が呪縛と完全に同じ波形を持つ……不気味な影が現れたか……' },
        { speaker: 'enemy', text: '・・・・' },
        { speaker: 'player', text: '……言葉も持たぬ、邪悪の泥人形か。だが、我が古代呪縛は、偽物の影などに敗れはしない。' },
  ...
  void: {
    late: {
      pre: [
        ...
        { speaker: 'player', text: '世界の平穏を脅かす邪悪の残滓、我が儀式用ナイフで完全排除する……！' }
      ],
      post: [
        { speaker: 'enemy', text: '……（黒き甲冑が崩れ去り、虚空の底へと消えていく……）' },
        { speaker: 'player', text: '……排除完了。ゼノンの消滅を確認した。' },
        { speaker: 'player', text: '第一回廊の魔力供給は絶たれた。さらに奥へ進むぞ、侵入者' }
      ]
    }
  },
  // 隷属の女王 ヴィオラ（第8戦）
  succubus: {
    late: {
      pre: [
        ...
        { speaker: 'player', text: '儀式用ナイフの錆にしてやる。完全排除する……！' }
      ],
      post: [
        { speaker: 'enemy', text: 'キャアアアッ！ この私が、負けるなんて……！ サタン様……！' },
        { speaker: 'player', text: '……排除完了。ヴィオラの魔鎖、完全に砕け散ったな。' },
        { speaker: 'player', text: 'これより玉座の間へ進む。侵入者、遅れるなよ' }
      ]
    }
  },
  // 魔王 サタン（第9戦）
  satan: {
    late: {
      ...
      post: [
        ...
        { speaker: 'player', text: '……見事だ、侵入者。魔王サタンの心臓を、ついに我が儀式用ナイフで貫いた。' },
