  ...
  android: {
    ...
    late: {
      pre: [
        ...
        { speaker: 'player', text: 'はぁ！？ 私の目の前で勝手に自滅するなんて絶対に許さないわよ！' },
        { speaker: 'player', text: '私のメイスで、その無謀な機能を一時停止させてあげる！' }
      ],
      post: [
        { speaker: 'enemy', text: 'アクチュエータの完全ロック……。これ以上の稼働は、不可能です……' },
        { speaker: 'player', text: 'アイギス、あんたもう動けないじゃない！ これ以上進んだら完全に粉々になっちゃうわ！' },
  ...
  dragon: {
    early: {
      ...
      post: [
        ...
        { speaker: 'player', text: 'ふん、私の勝ちね！ あんたの炎もなかなかの熱量だったけれど、このメイスを溶かすには全然足りないわよ。' },
  ...
  knight: {
    ...
    late: {
      ...
      post: [
        ...
        { speaker: 'player', text: 'これ以上進めば、ただの無駄死によ。大人しく傷を癒していなさい！' },
  ...
  cthulhu: {
    early: {
      ...
      post: [
        ...
        { speaker: 'player', text: 'ふん、私の勝ちね！ あんたの深海の狂気も、深淵の底までメイスで叩き割ってあげたわ。' },
        { speaker: 'player', text: 'お互い、旅を続けましょう！' }
      ]
    },
    late: {
      ...
      post: [
        ...
        { speaker: 'player', text: 'これ以上進んだら消滅しちゃうわ。大人しく傷を癒していなさい！' },
        { speaker: 'player', text: '魔王への神罰は、私とこの荷物持ちが代わりに下してあげるわ！' }
      ]
    }
  },
  ...
  elf: {
    early: {
      pre: [
        ...
        { speaker: 'player', text: '絶対に勝って、私への奉納品として頂いていくわよ！' }
      ],
      post: [
        { speaker: 'enemy', text: '私の矢がすべてメイスで弾き落とされるなんて……。あなたの信仰の力、本物だね' },
        { speaker: 'player', text: 'ふん、私の勝ちね！ あんたの正確な狙い撃ちもなかなか凄かったけれど、私のメイスには届かないわ。' },
        { speaker: 'player', text: 'お互い、旅を続けましょう！' }
      ]
    },
    late: {
      pre: [
        ...
        { speaker: 'player', text: '私のメイスで、その無謀な足を止めてあげるわ！' }
      ],
      post: [
        { speaker: 'enemy', text: 'ああっ……！ 弓を引く腕の筋肉が, もう言うことを聞かない……。私は、ここまでなの……？' },
        { speaker: 'player', text: 'リナ、あんたもう立っているのも限界じゃない！ これ以上進めば、確実に命を落とすわ。' },
  ...
  devilhunter: {
    early: {
      ...
      post: [
        ...
        { speaker: 'player', text: 'ふん、私の勝ちね！ リボルバーの銃撃もなかなか速かったけれど、' },
        { speaker: 'player', text: 'メイスの前にはただの鉄屑よ。お互い、旅を続けましょう！' }
      ]
    },
    late: {
      pre: [
      ...
      post: [
        ...
        { speaker: 'player', text: 'マリア、あんたもう指さえ動かないくらいボロボロじゃない！ 本当に棺桶に入るわよ。' },
        { speaker: 'player', text: '大人しく傷を癒していなさい！' },
        { speaker: 'player', text: '魔王への神罰は、私とこの荷物持ちが代わりに下してあげるわ！' }
      ]
    }
  ...
  witch: {
    early: {
      ...
      post: [
        ...
        { speaker: 'player', text: 'ふん、私の勝ちね！ 時間魔法とやらも、メイスの前にはただのガラクタ歯車よ。' },
        { speaker: 'player', text: 'お互い、旅を続けましょう！' }
      ]
    },
    late: {
  ...
  priest: {
    early: {
      ...
      post: [
        ...
        { speaker: 'player', text: 'ふん、私の勝ちね！ ナイフの攻撃もなかなか鋭かったけれど、' },
        { speaker: 'player', text: 'メイスの前には敵ではないわ。お互い、旅を続けましょう！' }
      ]
    },
    late: {
      pre: [
        ...
        { speaker: 'player', text: '私のメイスで、その冷たい呪いごとあんたを叩き伏せて止めてあげるわ！' }
      ],
      post: [
        { speaker: 'enemy', text: '……ぐ、はっ……！ 呪縛の侵食が……肉体の限界か……。王墓の平穏は……ここで途絶えるか……' },
        { speaker: 'player', text: 'ネフティ、あんたもう全身が冷え切っていてボロボロじゃない！ 消えちゃうわ。' },
        { speaker: 'player', text: '大人しく傷を癒していなさい！' },
