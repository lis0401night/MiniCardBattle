      ...
      <div style={{ textAlign: 'center', flexShrink: 0, marginBottom: '10px' }}>
        ...
        <div
          style={{
            fontSize: '1rem',
            fontWeight: 'bold',
            color: totalPoints === 20 ? '#ef4444' : '#cbd5e1',
            textShadow:
              totalPoints === 20 ? '0 0 10px rgba(239, 68, 68, 0.4)' : 'none',
          }}
        >
          現在の合計目標値: {totalPoints} / 20
        </div>
      </div>
