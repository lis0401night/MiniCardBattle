...
import { playSound, isTransitioning, switchScreen, getCardImgUrl } from '../utils/gameUtils.js';
...
export default function ExchangeScreen() {
  ...
  const updateExchange = () => {
    const currentPts = parseInt(localStorage.getItem('mini_card_battle_defense_points')) || 0;
    const totalPts = parseInt(localStorage.getItem('mini_card_battle_defense_total_points')) || 0;
