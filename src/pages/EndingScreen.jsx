...
import { returnToTitle } from '../hooks/battle.js';
...
export default function EndingScreen() {
    ...
    return (
        <div id="screen-ending-illust" className="screen active" style={{ backgroundColor: '#000', padding: 0 }} onClick={handleClickIllust}>
            <img 
                id="ending-illust-img" 
                src={GameState.playerConfig?.imageEnding || ''} 
                style={{ width: '100%', height: '100%', objectFit: 'cover', opacity: opacity, transition: 'opacity 2s' }} 
                alt="Ending"
            />
            <div 
                id="ending-text" 
