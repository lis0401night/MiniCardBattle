...
export default function HighDifficultyExchangeScreen() {
  const [highDifficultyPoints, setHighDifficultyPoints] = useState({
    current: 0,
    total: 0,
  });
  ...
  useEffect(() => {
    ...
    const currentPts =
      parseInt(
        localStorage.getItem('mini_card_battle_high_difficulty_points')
      ) || 0;
    const totalPts =
      parseInt(
