...
export const CARD_MASTER = [
    ...
    { id: 'specter', name: '魂の徴税人', power: 4, skills: [{ id: 'pierce' }, { id: 'extort', value: 1 }], rarity: 2, voiceCategory: 'undead', flavor: '異形のモンスターに跨り音もなく現れる槍を持った騎士の幽霊。' },
    ...
    { id: 'token_ent', name: 'エント', power: 5, skill: 'none', isToken: true, rarity: 1, voiceCategory: 'rock', flavor: '永き眠りから目覚めた大樹の精霊。森を脅かす者には、容赦のない鉄槌が下される。' }
];
